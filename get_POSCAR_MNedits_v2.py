...
####################################### Change File Type Naming Structure ###############################################

file_converted = input('What would you like to tag converted files with? (EXAMPLE: _POSCAR) Press enter for nothing.\n') #You may want to remove this so the .xyz and .POSCAR have the same name
#########################################################################################################################
